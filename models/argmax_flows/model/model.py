...
def add_model_args(parser):
    ...
    parser.add_argument('--model', type=str, default='coupling', choices={'ar', 'coupling'})
    ...
    if tmp_args.model == 'ar':
        ...
        # Encoder params
        parser.add_argument('--encoder_steps', type=int, default=0)
        parser.add_argument('--encoder_bins', type=int, default=4)

        # Context params
        parser.add_argument('--context_size', type=int, default=128)
        parser.add_argument('--context_lstm_layers', type=int, default=1)
        parser.add_argument('--context_lstm_size', type=int, default=256)
        ...
        parser.add_argument('--encoder_ff_size', type=int, default=128)

        # Context params
        parser.add_argument('--context_size', type=int, default=64)
        parser.add_argument('--context_ff_layers', type=int, default=1)
        parser.add_argument('--context_ff_size', type=int, default=128)
